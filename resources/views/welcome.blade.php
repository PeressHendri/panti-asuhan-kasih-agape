...
<head>
    ...
    <meta property="og:title" content="Panti Asuhan Kasih Agape - Diberkati Untuk Menjadi Berkat">
...
<body>
    ...
    <header class="header">
        ...
        <div class="header-right">
            <nav class="navbar">
                ...
                <a href="{{ route('public.donasi') }}" class="donate-link"><i class="fa-solid fa-heart"></i> Donasi</a>
        ...
        <div class="container">
            ...
            <div class="vision-content">
                ...
                <div class="vision-card">
                    ...
                    <h3>Misi</h3>
                    <p>Mendidik, memberikan pengajaran rohani, serta bekal pendidikan formal dan informal agar menjadi pribadi yang berintegritas.</p>
                </div>
                <div class="vision-card">
                    <i class="fa-solid fa-heart-pulse"></i>
                    <h3>Harapan</h3>
                    <p>Menjadikan Generasi Muda yang Memiliki Tanggung Jawab dan Memiliki Masa Depan Yang Cerah & Penuh Harapan.</p>
                </div>
            </div>

            <!-- Stats Section for Professionalism -->
            <div class="stats">
                <div class="stat-item">
                    <h2>{{ date('Y') - 2000 }}+</h2>
                    <p>Tahun Melayani</p>
                ...
                <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-card">
                                    <div class="company-box">
                                        ...
                                        @if($isVideo)
                                            <a class="glightbox" data-gallery="gallery1" href="{{ $fileUrl }}">
                                                <video preload="metadata" style="width: 100%; height: 100%; object-fit: cover; border-radius: 1.5rem; pointer-events: none;">
                                        ...
                                        @else
                                            <a class="glightbox" data-gallery="gallery1" href="{{ $fileUrl }}">
                                                <img src="{{ $fileUrl }}" alt="{{ $gallery->title ?: 'Galeri Panti' }}" loading="lazy">
                                            </a>
                                        @endif
                                    </div>
                    ...
                    @else
                        <div class="swiper-slide">
                            <div class="gallery-card">
                                <div class="company-box">
                                    <a class="glightbox" data-gallery="gallery1" href="{{ asset('assets/img/cewe-pcm.jpg') }}">
                                        <img src="{{ asset('assets/img/cewe-pcm.jpg') }}" alt="Default Galeri" loading="lazy">
                                    </a>
                                </div>
                                <div class="gallery-info">
                                    <h4>Panti Asuhan Kasih Agape</h4>
    ...
    <script>
        ...
        tsParticles.load('particles-js', {
            fpsLimit: 30,
            particles: {
                number: { value: isMobile ? 10 : 15, density: { enable: true, value_area: 800 } },
                color: { value: "#ffffff" },
                shape: {
                    type: "image",
                    image: [
                ...
                size: { value: { min: 15, max: 30 }, random: true },
                move: {
                    enable: true,
                    speed: 1,
                    direction: "right",
        ...
        const lightbox = GLightbox({
            ...
            loop: true,
            autoplayVideos: true,
            closeOnOutsideClick: true // Penting untuk memudahkan pengguna keluar
        });
    </script>
</body>
</html>