                                ...
                                <td>
                                    @if ($user->photo)
                                        <img src="{{ asset('storage/' . $user->photo) }}" width="50" height="50"
                                            style="object-fit:cover;" class="rounded-circle" alt="Foto">
                                    @else
...
@push('scripts')
    <script>
        ...
        // Fitur Toggle Password Show/Hide
        function togglePassword(buttonId, targetInputId, targetConfirmInputId = null) {
            ...
            if (input.type === 'password') {
                ...
                if (targetConfirmInputId) document.getElementById(targetConfirmInputId).type = 'text';
            } else {
                input.type = 'password';
                icon.classList.remove('fa-eye-slash');
                icon.classList.add('fa-eye');
                if (targetConfirmInputId) document.getElementById(targetConfirmInputId).type = 'password';
            }
        }
    </script>
@endpush